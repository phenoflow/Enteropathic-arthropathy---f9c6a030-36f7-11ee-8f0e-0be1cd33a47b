...
(async () => {
  ...
  await fs.writeFile("enteropathic-arthropathy-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("enteropathic-arthropathy-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
